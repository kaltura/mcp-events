...
exports.getKsFromRequest = getKsFromRequest;
exports.getRequiredKs = getRequiredKs;
/**
 ...
 */
function getKsFromRequest(request) {
 ...
 */
function getRequiredKs(request) {
    const ks = getKsFromRequest(request);
    if (!ks) {
        throw new Error('Kaltura Session (KS) is required. ' +
